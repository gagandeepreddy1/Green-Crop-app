...
import com.greencrop.singleton.intent
import com.greencrop.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textSignup?.setOnClickListener(){
            this.intent(SignUpActivity::class.java)
        }
